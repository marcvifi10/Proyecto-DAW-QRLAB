				...
				<div id="fons2" class="container content inici" style="min-height: 480px;">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-2 col-sm-2 col-lg-3">
							<!-- Creem el menú de l'opció estoc, que per defecte serà ocult -->
							<div id="menu_estoc">
								<div class="box">
									<h1>Opcions</h1>
									<div id="menu_estoc2">
							...
							<!-- Creem el menú per accedir a l'aplicació de llegir i generar codis QR; dintre de l'opció estoc del menú horitzontal i principal de la pàgina, que per defecte serà ocult -->
							<div id="menu_app">
								<div class="box">
									<h1>App</h1>
									<div id="menu_app2">
										<br>
										<!-- Botó per accedir a la pàgina per crear els diferents codis QR -->
										<a href="./qr/index.php" class="btn btn-default btn-md" target="_blank" style="width: 160px;">
											<font color="#333">Generar</font>
										</a>
										<hr>
										<!-- Botó per accedir a la pàgina per llegir els diferents codis QR -->
										<a href="./qr/readqr.php" class="btn btn-default btn-md" target="_blank" style="width: 160px;">
											<font color="#333">Escanejar</font>
										</a>
										<br>
										<br>
									</div>
						...
						<div class="col-xs-12 col-md-10 col-sm-10 col-lg-9">
							<div>
								<div id="contingut_inicial_estoc">
                                                                        <div class="box">
                                                                                <div align="left">
                                                                                        <h1>Introducció - Estoc</h1>
                                                                                </div>
                                                                                <div class="box-content" align="justify">
                                                                                        <font size="3">En aquesta secció, el que podrà fer serà el següent:</font>
                                                                                        <font size="2"><br><br>- Visualitza tot l'estoc entrat amb anterioritat.</font>
                                                                                        <font size="2"><br><br>- Imprimir en format informe tot l'estoc entrat.</font>
                                                                                        <font size="2"><br><br>- Anar a l'aplicació web, per generar els diferents codis QR, amb diferentes mides.</font>
											<font size="2"><br><br>- Anar a l'aplicació web, per llegir els diferents codis QR.</font>
                                                                                </div>
                                                                                </div>
                                                                        </div>
                                                                </div>
