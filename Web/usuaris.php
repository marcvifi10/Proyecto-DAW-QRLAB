					...
					<nav class="navbar navbar-default" role="navigation">
						...
						<div class="navbar-collapse collapse" aria-expanded="false" align="left" style="height: 1px;">
							<ul class="nav navbar-nav">
								...
								<li>
									<a id='substancia' href="substancia.php" class="pointer">Substància</a>
								</li>
								<li>
				...
				<div id="fons2" class="container content inici" style="min-height: 480px;">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-2 col-sm-2 col-lg-3">
							...
							<!-- Creem el menú de l'opció usuaris, que per defecte serà ocult -->
							<div id="menu_usuaris">
								<div class="box">
									<h1>Opcions</h1>
									<div id="menu_usuaris2">
										<br>
										<button type="button" class="btn btn-default btn-md" style="width: 160px;" onclick="afegir_usuari()">
											Afegir
										</button>
										<hr>
						...
						<div class="col-xs-12 col-md-10 col-sm-10 col-lg-9">
							<div id="contingut_inicial_usuaris">
                                                                        <div class="box">
                                                                                <div align="left">
                                                                                        <h1>Introducció - Usuaris</h1>
                                                                                </div>
                                                                                <div class="box-content" align="justify">
                                                                                        <font size="3">En aquesta secció, el que podrà fer serà el següent:</font>
                                                                                        <font size="2"><br><br>- Afegir un nou usuari.</font>
                                                                                        <font size="2"><br><br>- Modificar un usuari ja entrat.</font>
                                                                                </div>
                                                                        </div>
                                                        </div>
							<div id="c_afegir_usuari">
								<div class="box">
								...
								<br>
									...
									<form action="afegir_usuari.php" method="POST">
										<div class="form-group">
											<input name="codi_usuari" type="text" class="form-control" placeholder="Admin / Alumne / Professor">
										</div>
										<div class="form-group">
											<input name="nom_usuari" type="text" class="form-control" placeholder="Nom d'usuari">
										</div>
										<div class="form-group">
											<input name="contrasenya_usuari" type="password" class="form-control" placeholder="Contrasenya">
										</div>
										<div class="form-group">
											<input type="password" class="form-control" placeholder="Confirma la contrasenya">
										</div>
										<div class="form-group" align="left">
											<div class="form-control">
												<label><input name="actiu_usuari" type="checkbox" value=1> Actiu</label>
												<label><input name="inactiu_usuari" type="checkbox" value=0> Inactiu</label>
											</div>
										</div>
										<div align="left">
