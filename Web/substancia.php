				...
				<div id="fons2" class="container content inici" style="min-height: 480px;">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-2 col-sm-2 col-lg-3">
							<!-- Creem el menú de l'opció substància, que per defecte serà ocult -->
							<div id="menu_substancia">
								<div class="box">
									<h1>Opcions</h1>
									<div id="menu_substancia2">
										<br>
										<a type="button" class="btn btn-default btn-md" style="width:160px;" onclick="afegir_substancia()">
											Afegir
										</a>
										<hr>
										<button type="button" class="btn btn-default btn-md" style="width: 160px;" onclick="modificar_substancia()">
											Modificar
										</button>
										<hr>
						...
						<div class="col-xs-12 col-md-10 col-sm-10 col-lg-9">
							<div>
								<div id="contingut_inicial_sub">
									<div class="box">
										<div align="left">
											<h1>Introducció - Substància</h1>
										</div>
										<div class="box-content" align="justify">
											<font size="3">En aquesta secció, el que podrà fer serà el següent:</font>
											<font size="2"><br><br>- Afegir una nova substància.</font>
											<font size="2"><br><br>- Modificar una substància ja entrada.</font>
											<font size="2"><br><br>- Mostrar totes les substàncies entrades.</font>
										</div>
									</div>
								</div>
								<div id="contingut_afegir_substancia">
									<div class="box">
											<div align="left">
												<h1>Afegeix una substància</h1>
											</div>
											<div class="box-content" align="justify">
												<div class="box-content" align="center" style="text-align:center;">
													<div id="alerta1" class="alert alert-success" role="alert"></div>
					 								<form action="afegir_substancia.php" method="POST">
														<div class="form-group">
															<input name="nom_sub" type="text" class="form-control" placeholder="Nom">
                                                       	 							</div>
														<div class="form-group">
															<select id="tipus_subs" name="tipus_sub" class="form-control">
										
										</select>
        							                                                </div>
														<div class="form-group">
															<input name="cas_sub" type="text" class="form-control" placeholder="CAS">
														</div>
														<div class="form-group">
															<input name="puresa_sub" type="number" class="form-control" placeholder="Puresa">
														</div>
														<div class="form-group">
															<input name="formula_sub" type="text" class="form-control" placeholder="Fòrmula química">
														</div>
														<div class="form-group">
															<input name="u_min_sub" type="number" class="form-control" placeholder="Unitats mínimes">
                                                        							</div>
														<div class="form-group">
															<input name="u_estoc_sub" type="number" class="form-control" placeholder="Unitats d'estoc">
														</div>
														<div class="form-group">
															<input name="quantitat_sub" type="number" class="form-control" placeholder="Quantitat">
														</div>
														<div class="form-group" align="left">
															<select class="form-control" name="magnitut_sub">
														...
														<div>
															<input name="imatge_sub" type="file" class="form-control">
														</div>
														<br>
														<div align="left">
								...
								<div id="contingut_modificar_substancia">
									<div class="box">
										<div align="left">
											<h1>Modifica una substancia</h1>
										</div>
										<div class="box-content" align="left">
											<div class="box-content" align="center" style="text-align:center;">
												<div id="alerta1" class="alert alert-success" role="alert"></div>
					 							<form action="pagines/afegir_substancia.php" method="POST">
													<div class="form-group">
														<input name="mod_nom_sub" type="text" class="form-control" placeholder="Nom">
                                                        						</div>
													<div class="form-group">
														<input name="mod_tipus_sub" type="text" class="form-control" placeholder="Tipus">
                                                        						</div>
													<div class="form-group">
														<input name="mod_cas_sub" type="text" class="form-control" placeholder="CAS">
													</div>
													<div class="form-group">
														<input name="mod_puresa_sub" type="number" class="form-control" placeholder="Puresa">
													</div>
													<div class="form-group">
														<input name="mod_formula_sub" type="text" class="form-control" placeholder="Fòrmula química">
													</div>
													<div class="form-group">
														<input name="mod_u_min_sub" type="number" class="form-control" placeholder="Unitats mínimes">
                                                        						</div>
													<div class="form-group">
														<input name="mod_u_estoc_sub" type="number" class="form-control" placeholder="Unitats d'estoc">
													</div>
													<div class="form-group">
														<input name="mod_quantitat_sub" type="number" class="form-control" placeholder="Quantitat">
													</div>
													<div class="form-group" align="left">
														<select class="form-control" name="mod_magnitut_sub">
															<option selected value="mg">mg</option>
															<option value="g">g</option>
															<option value="ml">ml</option>
															<option value="l">l</option>
													...
													<div>
														<input name="mod_imatge_sub" type="file" class="form-control">
													</div>
													<br>
													<div align="left">
														<button type="submit" class="btn btn-primary">Afegeix</button>
